...
quant varchar (30) not null, -- alterar para int
tipo varchar (30) not null,
dataEntrada timestamp default current_timestamp,
dataSaida date,
quantminima varchar (250), -- alterar para int
valor decimal (10.2) not null,
idfor int, -- alterar para not null
...
produtos.nomeproduto,produtos.descricao,produtos.codigo,produtos.loc,
produtos.quant,
clientes.nome as cliente, clientes.telefone
from produtos
inner join clientes
on produtos.idfor = produtos.idfor
inner join fornecedores
on produtos.idfor = produtos.idfor
where quantminima >= quant;
