...
insert into servicos (corveiculo,placaveiculo,modeloveiculo,tipolavagem,valor,observacao,dataentrega,idcli)
values ('azul','123','fusca','ducha',120,'avaria lateral',20230523,1);
